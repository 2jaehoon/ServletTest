...
<div id="container">
<form id="frm" action="add_cookie" method="post" style="margin: 0px auto;">
<table>
<tr>
<td><input type="text" name="id" id="id" 
value="${ saveId }" class="inputBox"  autofocus="autofocus"  placeholder="아이디" style="width: 250px;height: 30px"/></td>
<td ><!-- el은 널인경우 출력안함 -->
<input type="checkbox" name="idSaveFlag" 
${ not empty saveId?"checked='checked'":"" } id="id" style="width: 30px;height: 30px;">
아이디 저장
</td>
</tr>
<tr>
...
<td>
<input type="button" value="로그인" id="btn" class="btnBorder" style="width: 100px;"/></td>
</tr>
</table>
</form>
</div>
