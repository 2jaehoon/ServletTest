<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"
    info="context param 사용"
    %>
    <%
    String commPath = application.getInitParameter("protocol")+
    application.getInitParameter("domain")+
    application.getInitParameter("context_path");
    %>
<!DOCTYPE html>
<html>
<head>
...
<link rel="stylesheet" type="text/css" href="<%=commPath %>common/main_v20230217.css"/> 
<style type="text/css">
...
position:relative;
background:#FFF url(<%=commPath %>common/images/header_bg.png) repeat-x;
}
