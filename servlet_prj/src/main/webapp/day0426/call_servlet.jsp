...
$(function(){
	$("#btn").click(function(){
		...
		obj.method = "get";
		//폼의 action 설정
		obj.action = "http://localhost/servlet_prj/hello";
		//폼의 enctype 설정
		obj.enctype = "multipart/form-data";
		alert( obj.method + " " + obj.action + " " + obj.enctype )
		
		obj.submit();
	});//click
	
	$("#btn2").click(function(){
		location.href="http://localhost/servlet_prj/hello";
	});//click
...
<div id="container">
<ul>
<li>링크를 사용한 호출 : <a href="../hello">서블렛 호출</a></li>
<li>url 링크를 사용한 호출 : <a href="http://localhost/servlet_prj/hello">서블렛 호출</a></li>
<li>폼 태그를 사용한 호출 : 
<form name="frm">
<input type="button" value="호출" id="btn" class="btn btn-danger"/>
</form>
</li>
<li>location 객체를 사용한 호출 : 
<input type="button" value="호출" id="btn2" class="btn btn-danger btn-lg"/>
</li>
</ul>
</div>
